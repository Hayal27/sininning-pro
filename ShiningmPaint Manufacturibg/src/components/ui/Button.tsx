...
const Button: FC<ButtonProps> = ({
  ...
  const variantClasses = {
    ...
    secondary: '  text-gray-800 border-2 border-gray-200 hover:border-blue-500 hover:text-blue-600 focus:ring-blue-500 shadow-md hover:shadow-lg',
    ...
    ghost: 'text-gray-700 hover: /50 hover:text-blue-600 focus:ring-gray-500 backdrop-blur-sm'
  };
